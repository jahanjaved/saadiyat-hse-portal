const MASTER = {
  ...
  "excelGapValues": [
    "1. Leadership failure\n2. Poor supervision\n3. Poor sub-contractor control\n4. PTW failure",
    "No significant gap observed",
    "1. Leadership failure\n2. Poor supervision\n3. Poor sub-contractor control",
    "1. Poor coordination \n2. Poor sub-contractor control\n4. PTW failure",
    "1. Poor sub-contractor control",
    ...
    "HSE Management System Implementation \n•\tPlanning and Control\n•\tInspection, Monitoring, and Compliance",
    "•HSE Management System Implementation \n•\tPlanning and Control\n•\tInspection, Monitoring, and Compliance",
    "1. Communication of OHS procedures \n2. lack of OHS awareness in supervision level \n3. Lack of monitoring",
    ...
    "1. Training and Awareness \n2.  Inadequate planning of activities \n3. Inadequate supervision",
  ...
  "presets": {
    "Edge Protection": {
      ...
      "preventive": [
        ...
        "Edge protection systems shall be extended to fully cover the entire leading edge, ensuring they effectively prevent falls from height.",
        ...
        "Immediate toolbox talks and training sessions shall be conducted for workers and supervisors regarding the importance of maintaining edge protection and safe work at height practices.",
        "Enhanced supervision and OSH surveillance shall be implemented to ensure strict compliance with approved method statements, risk assessments, and legal OSH requirements."
      ],
      "legal": [
        "ADOSH-SF CoP 23.0 - Working at Heights",
        "ADOSH-SF CoP 22.0 - Barricading of Hazards",
    ...
    "Scaffolding": {
      "description": [
        "A. It has been observed that spigot connections are not secured with an approved bolting system. Additionally, unauthorized modifications have been made to the scaffolding to facilitate the work activity, which are beyond the approved design.",
      ...
      "preventive": [
        ...
        "The modified or rectified scaffolding shall be erected strictly as per the approved design and applicable ADOSH requirements.",
        ...
        "Strict supervision and monitoring shall be enforced to ensure compliance with approved designs and prevent recurrence of similar unsafe practices."
      ],
      "legal": [
        "ADOSH-SF CoP 26.0 - Scaffolding",
        "ADOSH-SF CoP 23.0 - Working at Heights",
    ...
    "Access and Egress": {
      "description": [
        "A. Observed that access demarcation arrangements are in poor condition, with sharp-edged materials being used and no access signboards provided."
      ],
      "gaps": [
        "Planning and Control",
        "Inspection, Monitoring, and Compliance",
      ...
      "immediate": [
        ...
        "Unsafe materials were ordered to be removed from the access route."
      ],
      "preventive": [
        "All unsafe demarcation arrangements shall be removed immediately, particularly sharp-edged materials posing injury risks.",
        "Access routes shall be clearly defined using proper barricading systems without sharp edges.",
    ...
    "Barricading Hazards": {
      "description": [
        "A. Observed loose materials are placed near unprotected working platform edges, creating a potential risk of falling objects.",
        "B. Barricading arrangements were found to be incomplete and ineffective in preventing access to the hazard area."
      ],
      "gaps": [
        "Poor supervision",
        "Inspection, Monitoring, and Compliance",
      ...
      "immediate": [
        "The exposed area was isolated immediately and the supervision team was instructed to reinforce the barricading.",
        "Loose materials were removed from the hazard area."
      ],
      "preventive": [
        "All loose materials shall be immediately removed from the working platform edges and properly stored in designated secured areas.",
        "Working platforms shall be fully protected with compliant edge protection systems, including top rails, mid rails, and toe boards, as per applicable standards.",
        "Toe boards shall be installed along all open edges to prevent materials from falling from height.",
        "Warning signage and physical barriers shall be provided to prevent unauthorized access."
      ],
      "legal": [
        "ADOSH-SF CoP 22.0 - Barricading of Hazards",
        "Aldar OSH MS Rev-08"
    ...
    "Excavation Safety": {
      "description": [
        "A. Excavation work was observed without adequate edge protection, safe access, or sufficient control measures to prevent collapse and falls.",
        "B. The excavation area was not fully secured and inspection arrangements were not evident."
      ],
      "gaps": [
        "Poor planning",
        "Poor supervision",
      ...
      "immediate": [
        "Unsafe excavation activities were stopped and access to the excavation was restricted immediately.",
        "The excavation area was ordered to be barricaded and made safe."
      ],
      "preventive": [
        "Excavation works shall not proceed unless proper barricading, edge protection, and safe access arrangements are in place.",
        "Daily excavation inspections shall be carried out by a competent person and recorded.",
        "Suitable access and egress such as ladders or access points shall be provided.",
        "Excavated material and loose sand shall be kept away from the edge to avoid surcharge and collapse."
      ],
      "legal": [
        "ADOSH-SF CoP 29.0 - Excavation Work",
        "ADOSH-SF CoP 22.0 - Barricading of Hazards",
    ...
    "Permit to Work": {
      "description": [
        "A. Permit to Work implementation in the field was observed to be inadequate and not fully aligned with the actual work activities at the location.",
        "B. Supervision was not effectively verifying the permit conditions before and during the work."
      ],
      "gaps": [
        "PTW failure",
        "Poor supervision",
      ...
      "immediate": [
        "Work was suspended until the permit conditions were reviewed and verified.",
        "The supervision team was instructed to revalidate the permit controls before restarting work."
      ],
      "preventive": [
        "PTW shall be controlled by the main contractor and field verification shall be conducted before allowing the activity to proceed.",
        "Supervision shall ensure permit conditions are in line with the actual work location and risk controls.",
        "Regular PTW audits and spot checks shall be conducted to verify implementation in the field.",
        "Toolbox talks shall be conducted to ensure the workforce understands permit limitations and required controls."
      ],
      "legal": [
        "ADOSH-SF CoP 21.0 - Permit to Work Systems",
        "Aldar OSH MS Rev-08"
    ...
    "Housekeeping / Waste Management": {
      "description": [
        "A. Housekeeping standards were observed to be poor, with waste, loose materials, and obstructions affecting safe access and work execution.",
        "B. Waste collection arrangements and material storage controls require improvement."
      ],
      "gaps": [
        "Planning and Control",
        "Poor supervision",
      ...
      "immediate": [
        "Housekeeping and waste removal activities were initiated immediately.",
        "Obstructions were identified and the responsible team was instructed to clear access routes."
      ],
      "preventive": [
        "Proper waste collection points and housekeeping arrangements shall be established and maintained.",
        "Materials shall be stored only in designated areas and shall not obstruct access routes.",
        "Regular housekeeping inspections shall be carried out by the supervision team.",
        "Subcontractors shall be monitored to ensure continuous compliance with housekeeping standards."
      ],
      "legal": [
        "ADOSH-SF CoP 54.0 - Waste Management",
        "Aldar OSH MS Rev-08",
    ...
    "Electrical Safety": {
      "description": [
        "A. Electrical arrangements were observed to be unsafe due to damaged components, poor cable management, or inadequate protection of temporary electrical systems.",
        "B. Inspection and maintenance controls for temporary electrical equipment were not evident."
      ],
      "gaps": [
        "Inspection, Monitoring, and Compliance",
        "Poor supervision",
      ...
      "immediate": [
        "Unsafe electrical equipment was isolated immediately and the affected area was made safe.",
        "The responsible team was instructed to inspect and rectify the temporary electrical installation."
      ],
      "preventive": [
        "All temporary electrical systems shall be inspected and maintained in accordance with legal and project requirements.",
        "Damaged sockets, open distribution boards, exposed wiring, and poor cable routing shall be rectified immediately.",
        "Only competent personnel shall handle temporary electrical installations and modifications.",
        "Regular electrical safety inspections shall be implemented and recorded."
      ],
      "legal": [
...
function fillSimpleSelect(select, items, placeholder = "Select suggestion") {
  ...
  items.forEach(item => {
    const opt = document.createElement("option");
    opt.value = item;
    opt.textContent = item.length > 120 ? item.slice(0, 120) + "..." : item;
    select.appendChild(opt);
  });
}
...
function fillChips(container, items, textarea, replace=false) {
  ...
  items.forEach(item => {
    ...
    chip.type = "button";
    chip.className = "chip";
    chip.textContent = item.length > 80 ? item.slice(0, 80) + "..." : item;
...
function getPresetKey(card) {
  ...
  const activity = $(".mainHighRiskActivity", card).value;
  if (MASTER.presets[category]) return category;
  if (MASTER.presets[activity]) return activity;
  return "Other";
}
function applyPresetToCard(card, replaceText = true) {
  ...
  fillChips($(".gapChips", card), gapOptions.slice(0, 14), $(".topGaps", card));
  fillChips($(".immediateChips", card), immediateOptions.slice(0, 14), $(".immediateAction", card));
  fillChips($(".preventiveChips", card), preventiveOptions.slice(0, 16), $(".preventiveAction", card));

  if (replaceText) {
    setTextarea($(".observationDescription", card), preset.description || []);
    setTextarea($(".topGaps", card), (preset.gaps || []).map((g, i) => `${i+1}. ${g}`));
...
function addObservation(seed = null) {
  ...
  fillSelect($(".mainHighRiskActivity", card), MASTER.mainHighRiskActivities, "Select activity");
  ...
  $(".mainHighRiskActivity", live).addEventListener("change", () => applyPresetToCard(live, true));
...
function getObservations() {
  return $$(".obs-card").map((card, index) => ({
    ...
    mainHighRiskActivity: $(".mainHighRiskActivity", card).value,
...
function docParagraph(text, opts = {}) {
  return new window.docx.Paragraph({
    spacing: opts.spacing || { after: 0, before: 0, line: 240 },
    alignment: opts.alignment,
    children: [new window.docx.TextRun({ text, bold: !!opts.bold, font: "Calibri", size: opts.size || 22, color: opts.color })]
  });
}
async function generateWord() {
  ...
  setStatus("Generating final perfect ALDAR Word file...");
  ...
  const titleTable = new Table({
    ...
    rows:[new TableRow({children:[
      new TableCell({borders:noneBorder,width:{size:16,type:WidthType.PERCENTAGE},children:logoBuffer ? [new Paragraph({children:[new ImageRun({data:logoBuffer,transformation:{width:52,height:52}})]})] : [docParagraph(" ")]}),
      new TableCell({borders:noneBorder,width:{size:68,type:WidthType.PERCENTAGE},children:[new Paragraph({alignment:AlignmentType.CENTER,children:[new TextRun({text:"OSH Inspection Report",bold:true,font:"Calibri",size:28,color:"7f7f7f"})]})]}),
      new TableCell({borders:noneBorder,width:{size:16,type:WidthType.PERCENTAGE},children:[docParagraph(" ")]})
    ]})]
  });
  ...
  data.observations.forEach(obs => {
    ...
    addLine(`${obs.areaText}`, true);
    if (obs.mainHighRiskActivity) addLine(`Main High Risk Activity:${obs.mainHighRiskActivity}`, true);
  ...
  const safeRef = data.referenceNo.replace(/[^a-zA-Z0-9_-]+/g, "_");
  saveAs(blob, `Noor_Final_Perfect_ALDAR_${safeRef || "report"}.docx`);
  setStatus("Final perfect ALDAR Word file generated successfully.", "success");
}
function duplicateLast() {
  ...
  addObservation({
    ...
    mainHighRiskActivity: $(".mainHighRiskActivity", last).value,
