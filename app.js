...
const SMART_CATEGORY_ACTIONS = {
  "Edge Protection": {
    "immediate": [
      "Unsafe work near the exposed edge was stopped immediately and access to the affected area was restricted until proper edge protection was reinstated.",
      "The construction and HSE supervision team were called to the location and instructed to provide complete guardrails, mid-rails, toe boards and secured mesh before allowing work to continue.",
      "Workers were removed from the exposed edge area and the location was placed under control pending verification by the responsible supervisor."
    ],
    "preventive": [
      "All leading edges, slab openings and window openings shall be inspected before work starts and shall be protected with a complete and secure edge protection system.",
      "The Construction Manager shall assign competent supervision to verify edge protection daily and immediately reinstate any missing, loose or damaged section.",
      "A project-wide check shall be carried out for similar edge protection deficiencies, and repeated non-compliance shall be escalated through the contractor management system."
    ],
    "legal": [
      "ADOSH-SF CoP 23.0 - Working at Heights",
      "ADOSH-SF CoP 22.0 - Barricading of Hazards",
  ...
  "Scaffolding": {
    "immediate": [
      "Unsafe scaffold use was stopped immediately and the affected scaffold was restricted from use until inspected and accepted by a competent scaffolding inspector.",
      "The scaffolding team and site supervision were instructed to rectify missing components, unsafe access, tagging and stability issues before further use.",
      "Workers were removed from the unsafe scaffold arrangement and the area was controlled to prevent unauthorized access."
    ],
    "preventive": [
      "All scaffolds shall be erected, modified and dismantled only by competent scaffolders under supervision and in accordance with the approved design and manufacturer requirements.",
      "A competent scaffolding inspector shall inspect and tag scaffolds at the required frequency and after any modification, impact or adverse weather condition.",
      "The Construction Manager shall ensure scaffold inspections are tracked, closeout evidence is maintained, and non-compliant scaffolds are removed from service immediately."
    ],
    "legal": [
      "ADOSH-SF CoP 26.0 - Scaffolding",
      "ADOSH-SF CoP 23.0 - Working at Heights",
  ...
  "Access and Egress": {
    "immediate": [
      "Unsafe access and egress arrangements were stopped from use immediately and the affected route was isolated until a safe access arrangement was provided.",
      "The supervision team was instructed to remove obstructions and provide safe, stable and clearly defined access to the work area.",
      "Workers were redirected to a safer access route until the required access and egress controls were restored."
    ],
    "preventive": [
      "Safe access and egress shall be planned and provided before starting the activity, including stable walkways, stairs, ramps or platforms as required.",
      "Access routes shall remain clear, unobstructed, adequately barricaded and inspected by the responsible supervisor on a daily basis.",
      "The Construction Manager shall ensure access arrangements are included in the method statement, risk assessment and daily pre-start checks."
    ],
    "legal": [
      "ADOSH-SF CoP 22.0 - Barricading of Hazards",
      "ADOSH-SF CoP 37.0 - Ladders",
  ...
  "Barricading Hazards": {
    "immediate": [
      "The affected hazardous area was barricaded immediately to prevent unauthorized access and exposure of personnel.",
      "The responsible supervision team was instructed to replace inadequate barricades with rigid, visible and suitable barricading arrangements.",
      "Workers were kept away from the hazard until barricading, warning signs and access control were properly implemented."
    ],
    "preventive": [
      "All hazardous areas shall be identified, barricaded and signed before work starts, using suitable rigid barricades according to the level of risk.",
      "Barricades shall be inspected routinely and reinstated immediately if removed, damaged or displaced.",
      "The Construction Manager shall ensure supervisors verify barricading arrangements during daily inspections and stop work where barricading is inadequate."
    ],
    "legal": [
      "ADOSH-SF CoP 22.0 - Barricading of Hazards",
      "ADOSH-SF CoP 17.0 - Safety Signage and Signals",
  ...
  "Excavation Safety": {
    "immediate": [
      "Unsafe excavation activity was stopped immediately and the excavation edge was controlled until adequate barricading, access and inspection arrangements were provided.",
      "The responsible engineer and HSE team were called to the excavation area and instructed to rectify missing edge protection, unsafe access and inadequate demarcation.",
      "Personnel were prevented from entering or working near the excavation until the excavation controls were verified by competent supervision."
    ],
    "preventive": [
      "Excavations shall be inspected by a competent person before work starts and after any change in condition, with inspection records maintained at site.",
      "Safe access and egress, rigid barricading, warning signage and edge protection shall be provided and maintained for all excavation areas.",
      "Permit-to-work and excavation control measures shall be physically verified by the main contractor before allowing work to proceed."
    ],
    "legal": [
      "ADOSH-SF CoP 29.0 - Excavation Work",
      "ADOSH-SF CoP 22.0 - Barricading of Hazards",
  ...
  "Permit to Work": {
    "immediate": [
      "The activity was stopped immediately because the required permit-to-work control was not adequately verified at the work front.",
      "The responsible permit issuer, area engineer and HSE team were instructed to review the permit status and confirm all precautions before restarting work.",
      "Work was not allowed to continue until the permit conditions, isolations, supervision and site controls were physically verified."
    ],
    "preventive": [
      "Permit-to-work shall remain under the full control of the main contractor, and no activity shall start without a valid permit and field verification.",
      "Permit conditions shall be communicated to the workforce and verified by the responsible supervisor before and during the activity.",
      "Routine PTW audits shall be conducted to confirm that permit approvals, precautions, supervision and closeout records are properly implemented."
    ],
    "legal": [
      "ADOSH-SF CoP 21.0 - Permit to Work Systems",
      "Aldar OSH MS Rev-08",
  ...
  "Housekeeping / Waste Management": {
    "immediate": [
      "Poor housekeeping and waste accumulation were addressed immediately, and the responsible team was instructed to remove obstructions from access and work areas.",
      "The affected area was cleaned and unsafe material storage was controlled to reduce slip, trip, fire and access-related risks.",
      "The site team was instructed to provide proper waste collection arrangements and prevent further accumulation at the work front."
    ],
    "preventive": [
      "Adequate housekeeping arrangements shall be maintained at all times, with waste removed routinely and temporary storage areas clearly identified.",
      "Supervisors shall inspect their work areas daily to ensure access routes, emergency routes and work fronts remain clear and safe.",
      "Waste management responsibilities shall be assigned to each work team, and repeated housekeeping failures shall be escalated to project management."
    ],
    "legal": [
      "ADOSH-SF CoP 54.0 - Waste Management",
      "ADOSH-SF CoP 8.0 - General Workplace Amenities",
  ...
  "Electrical Safety": {
    "immediate": [
      "Unsafe electrical equipment or temporary electrical arrangements were stopped from use immediately and the affected system was isolated where required.",
      "A competent electrical person was instructed to inspect the distribution board, cables, tools and connections before allowing further use.",
      "Workers were kept away from the affected electrical installation until the unsafe condition was corrected and verified."
    ],
    "preventive": [
      "Distribution boards, temporary electrical systems, cables and tools shall be inspected routinely by competent electrical personnel and records shall be maintained.",
      "Damaged cables, open distribution boards, poor cable routing and unauthorized connections shall be removed or rectified immediately before use.",
      "The Construction Manager shall ensure temporary electrical arrangements are protected from mechanical damage, water exposure and unauthorized access."
    ],
    "legal": [
      "ADOSH-SF CoP 15.0 - Electrical Safety",
      "ADOSH-SF CoP 35.0 - Portable Power Tools",
  ...
  "Work at Height": {
    "immediate": [
      "Unsafe work at height was stopped immediately and workers were removed from the elevated work area until proper fall prevention controls were provided.",
      "The responsible supervisor and HSE team were instructed to verify safe access, edge protection, working platform and permit-to-work requirements before restart.",
      "The affected area below the work at height activity was controlled to prevent falling object and unauthorized access exposure."
    ],
    "preventive": [
      "All work at height activities shall be planned, risk assessed and controlled through suitable access, working platforms, edge protection and fall prevention measures.",
      "A valid work at height permit shall be issued only after the work front is physically verified and all required precautions are in place.",
      "Competent supervision shall remain present during work at height activities to ensure continuous compliance with project OSH requirements."
    ],
    "legal": [
      "ADOSH-SF CoP 23.0 - Working at Heights",
      "ADOSH-SF CoP 21.0 - Permit to Work Systems",
  ...
  "Falling Object Prevention": {
    "immediate": [
      "The activity was stopped immediately where falling object risk was identified and the drop zone was controlled.",
      "Loose materials and tools were removed or secured, and access below the work area was restricted.",
      "The supervision team was instructed to provide toe boards, debris netting, tool tethering or exclusion zones as required."
    ],
    "preventive": [
      "All work at height areas shall be assessed for falling object risk and suitable controls such as toe boards, netting, tool lanyards and exclusion zones shall be provided.",
      "Materials shall not be stored near edges unless properly secured and controlled by the responsible supervisor.",
      "Daily inspections shall verify that falling object controls remain effective before and during elevated works."
    ],
    "legal": [
      "ADOSH-SF CoP 23.0 - Working at Heights",
      "ADOSH-SF CoP 22.0 - Barricading of Hazards",
  ...
  "PTW Implementation": {
    "immediate": [
      "The activity was stopped immediately where PTW implementation was found inadequate at the work front.",
      "The permit issuer and area supervisor were instructed to review the permit conditions and verify that all required controls were in place.",
      "Work was not permitted to continue until the permit status and required safety precautions were confirmed."
    ],
    "preventive": [
      "The main contractor shall ensure PTW requirements are fully implemented before work starts, including approvals, precautions, supervision and communication to workers.",
      "Permit compliance shall be checked at the work front by the responsible supervisor and HSE team throughout the activity.",
      "PTW non-compliance shall be tracked, closed with evidence and escalated where repeated failures are identified."
    ],
    "legal": [
      "ADOSH-SF CoP 21.0 - Permit to Work Systems",
      "Aldar OSH MS Rev-08",
  ...
  "PTW Field Verification": {
    "immediate": [
      "Work was stopped because the permit controls were not adequately verified at the actual work location.",
      "The responsible supervisor was instructed to physically verify the work front, isolation, access, barricading and emergency controls before restart.",
      "The permit was reviewed against the actual site condition and the activity was held until compliance was confirmed."
    ],
    "preventive": [
      "Field verification shall be mandatory before authorizing high-risk work, and the permit shall match the actual site condition.",
      "Supervisors shall verify controls at the work front and record any required corrective action before allowing the activity to proceed.",
      "The HSE team shall conduct routine spot checks to ensure PTW field verification is effective and not treated as a paperwork exercise."
    ],
    "legal": [
      "ADOSH-SF CoP 21.0 - Permit to Work Systems",
      "Aldar OSH MS Rev-08",
  ...
  "MSRA Quality": {
    "immediate": [
      "The activity was paused where the approved method statement and risk assessment did not adequately reflect the actual site condition.",
      "The responsible engineer and HSE team were instructed to review the MSRA and communicate the required controls to the workforce.",
      "Work was not allowed to continue until the relevant hazards and control measures were clarified and implemented."
    ],
    "preventive": [
      "Method statements and risk assessments shall be reviewed against actual site conditions before work starts and updated when conditions change.",
      "Supervisors shall brief the workforce on activity-specific hazards, control measures and emergency arrangements through toolbox talks.",
      "The Construction Manager shall ensure MSRA implementation is verified at the work front and not limited to document approval."
    ],
    "legal": [
      "ADOSH-SF CoP 53.0 - OSH Management During Construction Work",
      "ADOSH-SF CoP 53.1 - OSH Construction Management Plan",
  ...
  "Lifting / Precast Installation": {
    "immediate": [
      "Unsafe lifting or precast installation activity was stopped immediately and the lifting area was controlled.",
      "The lifting supervisor and responsible engineer were instructed to verify the lifting plan, equipment certification, rigging arrangement and exclusion zone.",
      "Personnel were removed from the lifting zone until the required controls were confirmed."
    ],
    "preventive": [
      "All lifting and precast installation activities shall be carried out under an approved lifting plan and supervised by competent lifting personnel.",
      "Lifting equipment, accessories, A-frame arrangements and load securing methods shall be inspected and verified before use.",
      "Exclusion zones shall be established and maintained during lifting and precast installation to prevent unauthorized access."
    ],
    "legal": [
      "ADOSH-SF CoP 34.0 - Safe Use of Lifting Equipment and Lifting Accessories",
      "ADOSH-SF CoP 42.0 - Pre Cast Construction",
  ...
  "Traffic Interface": {
    "immediate": [
      "Unsafe traffic or man-machine interface condition was controlled immediately and the affected movement route was restricted.",
      "The logistics and supervision team were instructed to provide segregation, signage, banksman control and safe pedestrian routes.",
      "Plant or vehicle movement was held until the traffic control arrangement was corrected."
    ],
    "preventive": [
      "Traffic management arrangements shall be planned and maintained, including pedestrian segregation, signage, speed control, lighting and banksman arrangements.",
      "Plant and vehicle operators shall follow approved routes and shall not operate in uncontrolled pedestrian or work zones.",
      "Routine logistics inspections shall verify that man-machine interface controls remain effective across the work area."
    ],
    "legal": [
      "ADOSH-SF CoP 44.0 - Traffic Management and Logistics",
      "ADOSH-SF CoP 33.0 - Working On or Adjacent to a Road",
  ...
  "Welfare Arrangement": {
    "immediate": [
      "The welfare deficiency was communicated immediately to the responsible site team for correction.",
      "The affected welfare arrangement was reviewed and the contractor was instructed to provide suitable facilities without delay.",
      "Workers were advised to use approved welfare facilities until the deficient arrangement was corrected."
    ],
    "preventive": [
      "Adequate welfare facilities shall be provided, maintained and inspected regularly in line with project and legal requirements.",
      "The contractor shall ensure drinking water, sanitation, rest areas and heat stress controls are available and suitable for the workforce.",
      "Welfare conditions shall be monitored routinely, and deficiencies shall be closed with evidence by the responsible management team."
    ],
    "legal": [
      "ADOSH-SF CoP 8.0 - General Workplace Amenities",
      "ADOSH-SF CoP 11.0 - Safety in the Heat",
  ...
  "Fire Readiness": {
    "immediate": [
      "The fire readiness deficiency was addressed immediately and the responsible team was instructed to provide suitable firefighting controls.",
      "Unsafe storage or ignition sources were controlled and the affected area was reviewed for immediate fire risk.",
      "Required fire extinguishers, access routes and emergency arrangements were checked and corrected where deficient."
    ],
    "preventive": [
      "Fire readiness shall be maintained through adequate extinguishers, clear emergency access, proper storage control and regular inspection.",
      "Hot work, combustible materials and ignition sources shall be controlled through permit requirements and continuous supervision.",
      "The contractor shall verify fire prevention arrangements daily and ensure emergency contact details and response arrangements remain available."
    ],
    "legal": [
      "ADCD 2018 Fire & Life Safety Code of Practice",
      "ADOSH-SF CoP 28.0 - Hot Work Operations",
  ...
  "Electrical Tool Safety": {
    "immediate": [
      "Unsafe tools or electrical equipment were removed from use immediately and the responsible team was instructed to provide compliant equipment.",
      "The affected electrical tools, cables and connections were checked by competent personnel before further use.",
      "Workers were instructed not to use damaged or uncertified tools until inspection and replacement were completed."
    ],
    "preventive": [
      "Portable tools and electrical equipment shall be inspected, tagged and maintained by competent personnel before use.",
      "Damaged tools, exposed wiring, defective plugs and unsafe cable routing shall be removed from service immediately.",
      "Supervisors shall include tool and electrical safety checks in daily inspections and toolbox talks."
    ],
    "legal": [
      "ADOSH-SF CoP 35.0 - Portable Power Tools",
      "ADOSH-SF CoP 15.0 - Electrical Safety",
  ...
  "Temporary Structures": {
    "immediate": [
      "Unsafe temporary structure use was stopped immediately and access was restricted until approval and stability were verified.",
      "The responsible engineer was instructed to confirm design, inspection, anchoring and load requirements before further use.",
      "Personnel were prevented from using the temporary structure until the required controls were implemented."
    ],
    "preventive": [
      "Temporary structures shall be designed, approved, inspected and maintained in accordance with project requirements before use.",
      "Any modification to a temporary structure shall be reviewed and approved by competent engineering personnel before implementation.",
      "The contractor shall maintain inspection records and ensure temporary structures remain stable, suitable and safe throughout use."
    ],
    "legal": [
      "ADOSH-SF CoP 43.0 - Temporary Structures",
      "ADOSH-SF CoP 53.0 - OSH Management During Construction Work",
  ...
  "Other": {
    "immediate": [
      "The unsafe condition was communicated immediately to the responsible site team and temporary control measures were implemented.",
      "The affected activity or area was placed under control until suitable corrective measures were agreed and verified.",
      "The responsible supervision team was instructed to rectify the issue without delay."
    ],
    "preventive": [
      "The contractor shall review the unsafe condition, identify the root cause and implement corrective and preventive actions to avoid recurrence.",
      "The responsible management team shall verify closeout evidence and communicate lessons learned to the relevant supervisors and workforce.",
      "Routine inspection and monitoring shall be strengthened to ensure similar issues are identified and corrected early."
    ],
    "legal": [
      "Aldar OSH MS Rev-08",
      "Project Approved OSH Plan",
...
function applyPresetToCard(card, replaceText = true) {
  ...
  const smart = SMART_CATEGORY_ACTIONS[key] || SMART_CATEGORY_ACTIONS["Other"] || {};
  const immediateOptions = [...new Set([...(smart.immediate || preset.immediate || [])])];
  const preventiveOptions = [...new Set([...(smart.preventive || preset.preventive || [])])];
  ...
  if (replaceText) {
    ...
    setTextarea($(".immediateAction", card), immediateOptions[0] ? [immediateOptions[0]] : []);
    setTextarea($(".preventiveAction", card), humanizePreventiveAction((preventiveOptions || []).map((p, i) => `${i+1}. ${p}`).join("\n")));
  }

  const legalValues = new Set([...(smart.legal || preset.legal || [])]);
...
async function generateWord() {
  ...
  setStatus("Generating final ALDAR Projects Word file...");
  ...
  const headerLogo = new Paragraph({
    ...
    spacing: { after: 60 },
    children: [new ImageRun({ data: logoBuffer, transformation: { width: 82, height: 82 } })]
  });
  ...
  setStatus("Final Word file generated successfully.", "success");
}
